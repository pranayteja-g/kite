    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 dark:bg-neutral-950 px-4">
      <div className="w-full max-w-sm space-y-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-8 shadow-sm">
        ...
        <button
          ...
          className="w-full rounded-lg border border-neutral-300 dark:border-neutral-700 py-2.5 font-medium hover:bg-neutral-100 dark:hover:bg-neutral-900"
        >
          Continue with Google
        </button>

        <p className="text-center text-sm text-neutral-500">
          No account? <Link to="/signup" className="text-indigo-500 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
